...
<title>订单后台数据管理</title>
<meta name="description" content="订单数据管理">
<meta name="keywords" content="订单数据管理">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<%--</button>--%>
                                        <button type="button" class="btn btn-default" title="删除" onclick="delRow()">
	...
	<script>
        ...
        function delRow() {
            ...
            for (var i=0;i<chks.length;++i){
                if(chks[i].checked){
                    location.href = "${pageContext.request.contextPath}/orders/deleteOrders.do?id="+chks[i].value;
                }
            }
        }
