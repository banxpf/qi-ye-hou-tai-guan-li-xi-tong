				...
				<div class="box box-primary">
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
                                <li>
                                    <a href="${pageContext.request.contextPath}/role/findAll.do?page=1&size=${roleList.pageSize}" aria-label="Previous">首页</a>
                                </li>
                                ...
                                <c:forEach begin="1" end="${roleList.pages}" var="pageNum">
                                    <li><a href="${pageContext.request.contextPath}/role/findAll.do?page=${pageNum}&size=${roleList.pageSize}">${pageNum}</a></li>
                                </c:forEach>


                                <li><a href="${pageContext.request.contextPath}/role/findAll.do?page=${roleList.pageNum+1}&size=${roleList.pageSize}">下一页</a></li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/role/findAll.do?page=${roleList.pages}&size=${roleList.pageSize}" aria-label="Next">尾页</a>
                                </li>
							</ul>
						</div>
		...
		<script>
            ...
            function delRow() {
                ...
                for (var i=0;i<chks.length;++i){
                    if(chks[i].checked){
                        location.href = "${pageContext.request.contextPath}/role/deleteRole.do?id="+chks[i].value;
                    }
                }
            }
