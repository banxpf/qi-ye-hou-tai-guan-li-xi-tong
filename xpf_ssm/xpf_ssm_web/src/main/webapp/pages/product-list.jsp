...
<title>产品后台数据管理</title>
<meta name="description" content="产品后台数据管理">
<meta name="keywords" content="产品后台数据管理">
	...
	<script>
        ...
        function delRow() {
            ...
            for (var i=0;i<chks.length;++i){
                if(chks[i].checked){
                    location.href = "${pageContext.request.contextPath}/product/deleteProduct.do?id="+chks[i].value;
                }
            }
        }
